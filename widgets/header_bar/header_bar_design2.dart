...
class HeaderBarDesign2 extends StatelessWidget {
  final HeaderSettings headersettings;
  final String title;
  const HeaderBarDesign2(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          AutoBack(iconColor: theme.backgroundColor),
          if (Responsive.isMobile(context))
            if (settings!.header_bar.setting.hide_drawer_menu == 0)
              GestureDetector(
                  onTap: () {
                  ...
                  child: Padding(
                    ...
                    child: Icon(Iconsax.element_2,
                        size: 20, color: theme.backgroundColor),
                  )),
