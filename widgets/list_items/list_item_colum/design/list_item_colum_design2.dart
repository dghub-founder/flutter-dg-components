...
class ListItemColumDesign2 extends StatelessWidget {
  final String id;
  final String label1;
  final String label2;
  final String label3;
  ...
  const ListItemColumDesign2(
      {Key? key,
      required this.overlay_text,
      required this.overlay_image,
      required this.id,
                          ...
                          Align(
                            ...
                            child: Container(
                                ...
                                child: ImageViewNetwork(
                                    ...
                                    height: 20,
                                    radius: 100,
                                    url: DGTools.getHostUrl(overlay_image!)
                                        .toString())),
                          ),
                        if (overlay_text != '')
                          Align(
                          ...
                          Marquee(
                            child: Row(
                              children: [
                                Icon(
                                  Icons.star,
                                  size: Responsive.isMobile(context) ? 10 : 15,
                                  color: Colors.orange,
                                ),
                                Text(
                                  rating.toString(),
